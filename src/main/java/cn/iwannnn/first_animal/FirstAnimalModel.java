...
public class FirstAnimalModel extends EntityModel<FirstAnimal> {
    ...
    @Override
    public void setRotationAngles(FirstAnimal entityIn, float limbSwing, float limbSwingAmount, float ageInTicks,
    ...
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn,
        ...
        body.render(matrixStackIn, bufferIn, packedLightIn, packedLightIn);
    }
}
